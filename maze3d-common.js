...
class Maze3D {
  ...
  solveMaze(start, end) {
    ...
    if (this._isCharBlockade(this.barrierMaze[start[0]][start[1]][start[2]]) === "void" || this._isCharBlockade(this.barrierMaze[end[0]][end[1]][end[2]]) === "void") {
      throw new TypeError("solveMaze Error 3: Start and/or End Occupied with void");
    }
    if (this._isCharBlockade(this.barrierMaze[start[0]][start[1]][start[2]]) === "barrier" || this._isCharBlockade(this.barrierMaze[end[0]][end[1]][end[2]]) === "barrier") {
  ...
  _calculateMazeInstanceDetails() {
    ...
    this._mazeInstanceDetails = {
      ...
      pathDRC: [...this.path],
      voidCount: this.constraints.voidSpace.length,
      voidDRC: [...this.constraints.voidSpace],
      spaceCount: 0,
      spaceDRC: [],
      barrierCount: 0,
      barrierDRC: [],
  ...
  _animateSlices() {
    ...
    for (let group of groupOrder) {
      ...
      for (let groupItem of group) {
        ...
        groupItemTime += groupDelay + groupItemTime;
      }
    }
      ...
      for (let helper of Object.keys(this._sceneLights.lightHelpers)) {
        switch (action) {
          ...
          case "removeLightHelpers":
            ...
            console.log("Removing Light Helpers");
            break;
